...
. Follow the steps on the cluster's *Overview* page. In the *How to connect* section, click *Private Link*. 


== Access Redpanda services through VNet endpoint

Your connection URLs are available in the *How to Connect* section of your cluster's *Overview* page.
