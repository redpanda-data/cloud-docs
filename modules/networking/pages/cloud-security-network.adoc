...
| Redpanda Tiered Storage traffic | This depends on the cloud provider: +

*AWS*:  No, the VPC gateway endpoint is only a primitive in AWS.

*Azure*: Yes

*GCP*: No, Tiered Storage data transfer is free within the same region.
