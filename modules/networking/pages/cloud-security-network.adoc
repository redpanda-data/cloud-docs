...
You can find the NAT gateway address on the cluster *Overview* page on the *Internet gateway* field. This field is available for BYOC clusters (including BYOVPC/BYOVNet) and Dedicated clusters.
