...
* Use the Azure CLI to authenticate with Azure and retrieve the Private Link service credentials.
...
== Create new cluster with Private Link endpoint service enabled
...
== Enable Private Link endpoint service for existing clusters
