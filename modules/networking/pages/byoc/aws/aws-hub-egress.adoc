...
If you prefer to provision this infrastructure with Terraform, the configuration used to produce the setup in this guide is published in the Redpanda Cloud Examples repository:

https://github.com/redpanda-data/cloud-examples/tree/main/aws-hub-egress[redpanda-data/cloud-examples — aws-hub-egress^]
