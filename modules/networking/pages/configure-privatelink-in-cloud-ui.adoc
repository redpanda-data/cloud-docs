...
* Your Redpanda cluster and VPC must be in the same region. For cross-region PrivateLink connectivity, use the xref:networking:aws-privatelink.adoc#cross-region-privatelink[Cloud API].
