...
NOTE: This guide is for configuring AWS PrivateLink on Serverless clusters using the Redpanda Cloud Console. To configure and manage PrivateLink on an existing public cluster, you must use the xref:networking:serverless/aws/privatelink-api.adoc[Redpanda Cloud API].
