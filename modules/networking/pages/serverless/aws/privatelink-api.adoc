...
- `private_link_id`: The ID of an existing PrivateLink resource in the same resource group. You can find this in the cluster overview page in the Redpanda Cloud Console.
...
[,bash]
----
# Set the serverless region (for example, us-east-1)
SERVERLESS_REGION=<serverless_region>

# Set the PrivateLink ID
