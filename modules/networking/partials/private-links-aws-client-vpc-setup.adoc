To connect your client VPC to your PrivateLink-enabled Redpanda cluster, complete the following steps using the AWS CLI.
...
NOTE: The following example uses `0.0.0.0/0` as the CIDR range for illustration. In production, replace `0.0.0.0/0` with the specific CIDR range of your client VPC or on-premises network to limit exposure.
