...
. In **Cluster settings**, copy the **Service attachment URL** and **DNS Zone** under **Private Service Connect**. Use this URL to create the Private Service Connect endpoint in GCP.
