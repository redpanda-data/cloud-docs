...
When a Redpanda topic is configured as an glossterm:Iceberg topic[], Redpanda SQL queries its Iceberg-committed data through the same SQL interface as live streaming topics, reading Parquet data and Iceberg metadata directly from cloud storage.
