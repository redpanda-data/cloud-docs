...
TIP: You can also query data directly in the Cloud Console using the built-in xref:sql:query-data/sql-editor.adoc[SQL editor], with no separate client required.

SQL connection details are available on the *SQL* tab under *Connection details* in the https://cloud.redpanda.com/[Cloud Console]. To connect using `psql`:
