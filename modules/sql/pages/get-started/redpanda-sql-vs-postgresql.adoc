...
// and add: unsupported statement classes (DDL/DML other than the
// catalog/table mappings, transactions, stored procedures, triggers,
// extensions), data-type coverage gaps, system-catalog coverage,
// authn/authz model differences, session/transaction semantics, and
// connection-protocol limitations. Scope this list with engineering
// before publication.
