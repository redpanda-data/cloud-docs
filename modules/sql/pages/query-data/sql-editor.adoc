...
* A Redpanda Cloud user with the *SQL: Access* or *SQL: Manage* RBAC permission. Users with *SQL: Access* also need a `GRANT SELECT` on each table to run queries against it. See xref:sql:manage/manage-access.adoc[Manage access to Redpanda SQL].
