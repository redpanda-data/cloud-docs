...
The `POSITION()` function returns the position of the first occurrence of a substring in a string. It works the same as xref:sql:reference/sql-functions/string-functions/strpos.adoc[STRPOS], but it has slightly different syntax.
