...
The `VAR++_++POP()` aggregate function calculates the population variance of a set of numeric values.
...
The query below uses the `VAR++_++POP()` function to calculate the population variance for the `length` column:
