...
The `STDDEV++_++POP()` aggregate function calculates the population stardard deviation of a set of numeric values.
...
They query below uses the `STDDEV++_++POP()` function to calculate the population standard deviation for the `length` column:
