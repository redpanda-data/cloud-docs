...
* `number`: The number to round, it can be positive, negative, or zero, and it can be an xref:sql:reference/sql-data-types/numeric-type/numeric.adoc[Integer] or a xref:sql:reference/sql-data-types/numeric-type/numeric.adoc[Double Precision].
