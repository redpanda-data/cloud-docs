...
If two or more tables are listed in the `FROM` clause, these tables are joined using xref:sql:reference/sql-clauses/from/join.adoc[JOIN], xref:sql:reference/sql-clauses/from/right-join.adoc[RIGHT JOIN], xref:sql:reference/sql-clauses/from/left-join.adoc[LEFT JOIN], or xref:sql:reference/sql-clauses/from/outer-join.adoc[OUTER JOIN], depending on the operations to be queried as seen in the syntax below:
...
click xref:sql:reference/schema.adoc[here] for more info.
====
...
xref:sql:reference/sql-clauses/from/join.adoc[JOIN],
xref:sql:reference/sql-clauses/from/right-join.adoc[RIGHT JOIN],
xref:sql:reference/sql-clauses/from/left-join.adoc[LEFT JOIN], or
xref:sql:reference/sql-clauses/from/outer-join.adoc[OUTER JOIN].
====
...
. Set the tables into a new temporary relation (`table++_++2 as X, table++_++1 as Y`).
