...
* *Authentication*: Your OIDC identity provider authenticates the user, configured at the cluster level. For the client-side connection guide, see xref:sql:connect-to-sql/connect-with-oidc.adoc[].
