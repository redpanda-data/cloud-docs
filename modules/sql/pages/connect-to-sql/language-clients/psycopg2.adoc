...
Psycopg2 is a https://www.psycopg.org/docs/[PostgreSQL adapter for Python^] programming language. It allows you to execute SQL queries and interact with your Redpanda SQL instance using Python and is designed for multi-threaded applications that create and destroy lots of cursors (more on them https://www.psycopg.org/docs/cursor.html[here^]) and make a large number of concurrent `INSERT`s or `UPDATE`s.
