= Psycopg2
:description: Connect a Python application to Redpanda SQL using the Psycopg2 PostgreSQL adapter.
:page-topic-type: how-to

Psycopg2 is a https://www.psycopg.org/docs/[PostgreSQL adapter for Python^]. You can use it to execute SQL queries against Redpanda SQL from Python. Psycopg2 is designed for multi-threaded applications that create and destroy many https://www.psycopg.org/docs/cursor.html[cursors^] or run a high number of concurrent `INSERT` or `UPDATE` operations.
