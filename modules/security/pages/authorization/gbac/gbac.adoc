...
include::streaming:manage:partial$gbac-token-claim-extraction.adoc[]
...
+
--
Make a link:/api/doc/cloud-controlplane/operation/operation-groupservice_creategroup[`POST /v1/groups`] request to the xref:cloud-data-platform:manage:api/cloud-byoc-controlplane-api.adoc[Control Plane API]:
