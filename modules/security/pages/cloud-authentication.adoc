...
* With user impersonation, Redpanda Cloud evaluates permissions using RBAC and ACLs. 
...
* Access to the xref:manage:api/cloud-api-overview.adoc[Cloud API]
