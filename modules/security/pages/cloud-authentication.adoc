...
To integrate with Entra ID, follow the https://learn.microsoft.com/en-us/entra/identity-platform/v2-protocols-oidc[Microsoft documentation^] to create an OIDC application and enable the ID token with Entra ID:

. In the https://www.microsoft.com/en-us/security/business/identity-access/microsoft-entra-id[Entra App Gallery^], in the Create your own application page: 
...
+
Users with an email address with the realm added can now access your Redpanda Cloud account. 
+
