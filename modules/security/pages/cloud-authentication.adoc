...
* Kafka API: Redpanda Cloud supports both SASL (over TLS 1.2) and mutual TLS (mTLS) authentication for Kafka clients connecting to Redpanda clusters over the TCP endpoint or listener.
