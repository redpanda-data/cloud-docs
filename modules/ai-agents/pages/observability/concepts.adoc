...
| LLM provider API call showing calls to the language model. The span name matches the provider, and attributes typically include the model name (like `gpt-4o` or `claude-sonnet-4`).
...
│   │   └── openai: chat gpt-4o (6.2 seconds)
----
