...
* **Time**: When the glossterm:span[span] started (sortable)
...
* **Raw data tab**: Complete glossterm:opentelemetry[OpenTelemetry] span in JSON format. You can also view raw transcript data in the `redpanda.otel_traces` topic.
