...
* *API Base URL*: `https://{CLUSTER_ID}.cloud.redpanda.com/ai-gateway/v1`
* *API Key*: The API token generated earlier
* *Custom Headers*: Add `rp-aigw-id` with value `GATEWAY_ID`
...
This configuration connects Cline to the aggregated MCP endpoint with authentication and gateway identification headers.
