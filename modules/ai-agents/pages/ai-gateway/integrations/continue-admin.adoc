...
Continue.dev uses a YAML configuration file:
...
This configuration connects Continue.dev to the aggregated MCP endpoint with authentication and gateway identification headers.
