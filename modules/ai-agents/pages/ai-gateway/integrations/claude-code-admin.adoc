...
:description: Configure Redpanda AI Gateway to support Claude Code clients with LLM routing, MCP tool aggregation, and authentication.
...
Alternatively, users can edit `~/.claude/config.json`:
