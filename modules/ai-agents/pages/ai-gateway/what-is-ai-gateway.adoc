= DRAFT: What is Redpanda AI Gateway?
:description: Introduction to the AI Gateway.
...
* *Define policies* → link:routing-rate-limits.adoc[Routing and Rate Limits Guide]
