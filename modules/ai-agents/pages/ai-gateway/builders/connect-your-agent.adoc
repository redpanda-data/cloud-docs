= Connect Your Agent
:description: Integrate your AI agent or application with Redpanda AI Gateway for unified LLM access.
...
response = client.chat.completions.create(
    model="openai/gpt-4o-mini",  # Note: vendor/model_id format
