...
* xref:ai-agents:ai-gateway/observability-logs.adoc[]: Monitor MCP usage in request logs.
* xref:ai-agents:ai-gateway/observability-metrics.adoc[]: Track MCP metrics and costs.