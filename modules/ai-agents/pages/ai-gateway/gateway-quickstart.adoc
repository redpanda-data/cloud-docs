...
. After creation, copy the *Gateway Endpoint* and *Gateway ID* from the gateway overview page. You'll need these for sending requests. For example, you might see:
----
Endpoint: https://example/gateways/d633lffcc16s73ct95mg/v1
ID: d633lffcc16s73ct95mg
----
