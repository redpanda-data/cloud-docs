= Migrate from Direct Provider Integration to AI Gateway
...
* Enabled providers and models (see [Admin Guide: Providers](// PLACEHOLDER: link))
* Created gateway with appropriate policies (see [Gateway Creation Guide](// PLACEHOLDER: link))
