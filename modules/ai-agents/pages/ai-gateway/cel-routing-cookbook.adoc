...
response = client.chat.completions.create(
    model="openai/gpt-4o",  # CEL routing rules override model selection
...
request.headers["x-user-region"] == "eu"
  ? "anthropic/claude-sonnet-3.5"  // EU traffic to Anthropic
  : "openai/gpt-4o"                // Other traffic to OpenAI
----
...
# Check logs: Should route to anthropic/claude-sonnet-3.5
----
