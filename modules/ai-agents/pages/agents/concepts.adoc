...
For guidance on consuming these topics, analyzing conversation history, and monitoring agent performance, see xref:ai-agents:observability/monitor-agents.adoc[].
