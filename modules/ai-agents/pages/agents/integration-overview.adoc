...
:personas: ai_agent_developer, streaming_developer, app_developer, data_engineer
...
* xref:ai-agents:agents/a2a-concepts.adoc[]: Learn about the A2A protocol that powers agent communication
* xref:ai-agents:mcp/remote/tool-patterns.adoc[]: Explore MCP tool patterns and examples
* xref:ai-agents:agents/pipeline-integration-patterns.adoc[]: Build pipelines that call agents
