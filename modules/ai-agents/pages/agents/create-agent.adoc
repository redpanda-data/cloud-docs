...
Create a new AI agent through the Redpanda Cloud UI. This guide walks you through configuring the agent's model, system prompt, tools, and execution settings.
...
The *Inspector* tab in the Cloud UI automatically uses this URL to connect to your agent for testing.
