...
The agent card is a JSON document that describes what the agent can do and how to interact with it.
...
----
{
  ...
  "description": "Analyzes transactions for fraudulent activity",
  "capabilities": {
    "streaming": true,
    "synchronous": true
  },
