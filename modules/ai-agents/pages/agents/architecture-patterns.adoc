...
Choose models based on task complexity, latency requirements, and cost constraints. The Redpanda Cloud UI displays available models with descriptions when creating agents.
