...
* A xref:get-started:cluster-types/byoc/index.adoc[BYOC cluster] on AWS running Redpanda version 25.3 and later.
...
. Go to *Topics* in the Redpanda Cloud UI.
. Click *Create Topic*.
...
. Go to *Security* > *Users* in the Redpanda Cloud UI.
. Click *Create User*.
. Configure the user:
+
...
. Go to *Connect* > *Secrets* in the Redpanda Cloud UI (if not already there).
. Click *Create Secret*.
...
. Go to *Connect* in the Redpanda Cloud UI.
