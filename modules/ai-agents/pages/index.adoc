...
**Local MCP server for Redpanda Cloud** badge::[label=beta, tooltip={page-beta-text}]: A built-in server that gives your AI assistant direct access to your Redpanda Cloud account and clusters. This runs locally on your computer and lets you quickly perform operations like creating clusters, listing topics, and reading messages.
