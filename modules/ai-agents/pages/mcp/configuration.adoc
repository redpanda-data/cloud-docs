...
:page-aliases: mcp/local/configuration.adoc
:page-beta: true
...
+
[[local]]
. Start the server manually using the `rpk cloud mcp stdio` command (one-time login required) to verify connectivity to Redpanda Cloud endpoints:
