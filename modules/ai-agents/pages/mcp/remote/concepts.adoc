...
:learning-objective-1: Explain how MCP tools differ from pipelines
:learning-objective-2: Choose the right component type for a use case
:learning-objective-3: Understand MCP server traces for observability
...
include::redpanda-connect:ai-agents:partial$mcp/concepts/mcp-tools-concept.adoc[]
