...
Remote MCP server:: An MCP server that you build and host in your Redpanda Cloud cluster using Redpanda Connect. It exposes custom tools that AI assistants can call to access your data and workflows.
