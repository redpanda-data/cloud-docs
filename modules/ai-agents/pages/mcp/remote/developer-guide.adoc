...
* Document defaults in the `description` and enforce them in the logic.
...
When your tool is ready, deploy it as part of your remote MCP server in Redpanda Cloud and test it with the built-in MCP Inspector.
