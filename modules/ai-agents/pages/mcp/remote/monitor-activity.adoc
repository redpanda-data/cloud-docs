...
:personas: platform_engineer_sre, ai_agent_developer, data_engineer_pipeline_architect
...
This guide shows you how to monitor your MCP servers using the execution log.
...
For conceptual background on traces and spans, see xref:ai-agents:mcp/remote/concepts.adoc#execution-log[Execution log and observability]. For the trace data structure specification, see xref:ai-agents:mcp/remote/reference.adoc#trace-data-structure[Trace data structure].
...
* xref:ai-agents:mcp/remote/concepts.adoc#execution-log[]: Learn how traces and spans work
* xref:ai-agents:mcp/remote/reference.adoc#trace-data-structure[]: Look up trace field specifications
