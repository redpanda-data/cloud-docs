...
This page provides a reference catalog of patterns designed for use with MCP servers in Redpanda Cloud. Use these patterns as building blocks for your own MCP tools.
...
TIP: For step-by-step instructions, see xref:ai-agents:mcp/remote/quickstart.adoc[]. For best practices, see xref:ai-agents:mcp/remote/best-practices.adoc[]. For conceptual background, see xref:ai-agents:mcp/remote/concepts.adoc[].
