...
include::redpanda-connect:ai-agents:partial$mcp/best-practices/input-validation.adoc[leveloffset=+1]
...
include::redpanda-connect:ai-agents:partial$mcp/best-practices/error-handling.adoc[leveloffset=+1]

=== Response formatting

AI clients work best with clean, predictable response structures. Transform raw component output into consistent formats.

include::redpanda-connect:ai-agents:partial$mcp/best-practices/response-formatting.adoc[leveloffset=+1]
