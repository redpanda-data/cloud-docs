...
In Redpanda Cloud, you create tools directly in the Cloud UI or using the Data Plane API.
...
When you add secret references to your tool configuration, the Cloud UI automatically detects them and provides an interface to create the required secrets.
