...
:description: Learn how to edit, stop, start, and delete Remote MCP servers in Redpanda Cloud.

This guide shows you how to manage the lifecycle of Remote MCP servers, including editing configurations, pausing servers to save costs, and permanent deletion.
