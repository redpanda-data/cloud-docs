...
. Open the *Connection* tab in Redpanda Cloud to get connection details and run the `rpk` command for Claude Code. It looks like this:
+
[,bash]
----
...
- Check that your rpk version is 25.2.3 or later: `rpk version`.
