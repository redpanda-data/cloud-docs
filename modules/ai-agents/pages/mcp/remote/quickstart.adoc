...
. Navigate to *Agentic AI* > *Remote MCP*.
+
...
+
* *Display Name*: A human-friendly name such as `event-data-generator`. This name is shown in the Redpanda Cloud UI. It is not the name of the MCP server itself.
...
* xref:ai-agents:mcp/remote/admin-guide.adoc[]
