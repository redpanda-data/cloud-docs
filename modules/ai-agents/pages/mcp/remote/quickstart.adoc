...
* **MCP Server**: Hosts a collection of tools that perform specific actions. Remote MCP servers run as managed services in your Redpanda Cloud cluster.
...
Now that your MCP server is running with two tools available, you'll connect Claude Code so it can discover and use them. You can connect any MCP-compatible AI client to your Remote MCP server.
