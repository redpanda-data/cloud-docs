= Redpanda Cloud API MCP Quickstart
:page-beta: true
:description: Connect your Claude AI agent to your Redpanda Cloud account and clusters using the Redpanda Cloud API MCP.
...
In this quickstart, you'll get your Claude AI agent talking to Redpanda Cloud using the xref:ai-agents:mcp/local/overview.adoc[Redpanda Cloud API MCP].
