= Configure the Redpanda Cloud API MCP
:page-beta: true
:description: Learn how to configure the Redpanda Cloud API MCP, including auto and manual client setup, enabling deletes, and security considerations.
...
After installing the Redpanda Cloud API MCP, you can configure it for different AI clients, customize security settings, and troubleshoot common issues.
...
If you're using another MCP-compatible client, manually configure it to use the Redpanda Cloud API MCP. Follow these steps:
