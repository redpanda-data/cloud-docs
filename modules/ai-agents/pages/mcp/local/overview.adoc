...
:page-beta: true
:description: Learn about the local MCP server for Redpanda Cloud, which lets AI agents securely access and operate your Redpanda Cloud account and clusters.
...
:learning-objective-1: Explain what the local MCP server does
...
The local MCP server for Redpanda Cloud lets AI agents securely access and operate your Redpanda Cloud account and clusters. MCP provides controlled access to:
...
* xref:ai-agents:mcp/local/quickstart.adoc[Local MCP server quickstart]
* xref:ai-agents:mcp/local/configuration.adoc[Configure the local MCP server]
