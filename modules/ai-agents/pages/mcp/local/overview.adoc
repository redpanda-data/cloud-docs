...
:page-beta: true
:description: Learn about the Redpanda Cloud API MCP, which lets AI agents securely access and operate your Redpanda Cloud account and clusters.
...
:learning-objective-1: Explain what the Redpanda Cloud API MCP does
...
The Redpanda Cloud API MCP lets AI agents securely access and operate your Redpanda Cloud account and clusters. MCP provides controlled access to:
...
image::shared:cloud-mcp.gif[A terminal window showing Claude Code invoking the Redpanda Cloud API MCP to list topics in a cluster.]
...
* xref:ai-agents:mcp/local/quickstart.adoc[Redpanda Cloud API MCP quickstart]
* xref:ai-agents:mcp/local/configuration.adoc[Configure the Redpanda Cloud API MCP]
