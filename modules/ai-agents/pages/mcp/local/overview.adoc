...
:personas: absolute_beginner, ai_agent_developer, redpanda_cloud_user, platform_engineer_sre
...
* xref:home:ROOT:mcp-setup.adoc[Read-only MCP server for Redpanda docs]: Access Redpanda documentation and examples through AI assistants
