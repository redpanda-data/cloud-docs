...
You can subscribe to Redpanda Cloud through Azure Marketplace and use your existing marketplace billing and credits to quickly provision Redpanda Dedicated Cloud clusters. View your bills and manage your subscription directly in the marketplace.
...
[IMPORTANT]
====
When you subscribe to Redpanda Cloud through Azure Marketplace, you can only create clusters on AWS. 
====
