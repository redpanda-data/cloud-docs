...
* xref:get-started:cluster-types/serverless.adoc#create-a-new-serverless-standard-cluster[Create a new Serverless Standard cluster]
* xref:get-started:cluster-types/serverless-pro.adoc#create-a-new-serverless-pro-cluster[Create a new Serverless Pro cluster]
