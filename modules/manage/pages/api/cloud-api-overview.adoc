...
* You can only use one organization for authentication. See link:/api/doc/cloud-controlplane/authentication[Cloud API Authentication] for steps to authenticate API requests.
...
* link:/api/doc/cloud-controlplane/[Control Plane API reference]
* link:/api/doc/cloud-dataplane/[Data Plane API reference]
...
The Cloud API Deprecation Policy outlines the process for phasing out an API version or specific features within an API. See link:/api/doc/cloud-controlplane/topic/topic-deprecation-policy[Deprecation Policy] for details.
