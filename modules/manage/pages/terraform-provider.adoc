...
.. Navigate to the *Organization IAM* page and go to the *Service account* tab. Click on *Create service account* to create the service account with a user provided name.
