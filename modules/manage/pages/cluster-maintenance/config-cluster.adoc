...
* *Redpanda version 25.1.2+*: To configure cluster properties, the cluster must be running Redpanda version 25.1.2 or later. You can find the version on your cluster's Overview page in the Redpanda Cloud UI. 
