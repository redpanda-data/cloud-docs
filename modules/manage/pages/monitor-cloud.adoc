...
You can configure monitoring on your Redpanda BYOC or Dedicated cluster to maintain system health and optimize performance. You can monitor Redpanda with Prometheus or with any other monitoring and alerting tool, such as Datadog, New Relic, Elastic Cloud, Google, or Azure.
...
. Save this information to Prometheus, and observe in Prometheus that Redpanda metrics are scraped.
