...
Contextual variables provide an easy way to access information about the environment in which a data pipeline is running and the pipeline itself. You can use any of the following contextual variables in your pipeline configurations:
