...
Redpanda Connect in Redpanda Cloud lets you quickly build and deploy streaming data pipelines on your clusters from a fully integrated UI or using the xref:api:ROOT:cloud-api.adoc#tag--PipelineService[Control Plane API]. 
...
Comprehensive data pipeline metrics are also available to help you to xref:develop:connect/configuration/monitor-connect.adoc[monitor the behavior, health, and performance of your data pipelines].
