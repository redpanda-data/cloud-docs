...
.. Copy and save the password generated for this user; you'll need it later.
...
.. In the YAML, add the saved password for the `connect` user on the last line.
...
.. In the YAML, add the saved password for the `connect` user after `password:`.
.. Click **Create** to start your pipeline.
