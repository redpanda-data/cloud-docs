...
TIP: Advanced users can skip directly to the *Edit pipeline* step to configure the YAML file themselves. 
...
+
Once running, your pipeline will generate new names every second and write the processed messages to the **sample-topic** topic.
