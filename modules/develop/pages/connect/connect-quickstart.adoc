...
* `${REDPANDA_BROKERS}` is a contextual variable that references the bootstrap server address of your cluster. You can add this variable to any pipeline on your cluster.
