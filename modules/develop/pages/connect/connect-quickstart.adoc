...
Follow this quickstart to create a Redpanda Connect pipeline. Pipelines help you stream data into and out of Redpanda without writing producer/consumer code. 

NOTE: Advanced users can skip directly to the *Edit pipeline* step to configure the YAML file themselves. 
