...
TIP: The following screenshot shows helpful features in the user interface. The editor provides an IDE-like experience for creating pipelines. After a component has been added, you can click the leaf in the left sidebar to learn more about it in the documentation. 
