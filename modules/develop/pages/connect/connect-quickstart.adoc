...
A Redpanda Cloud account for Serverless Standard, Serverless Pro, Dedicated or standard BYOC (not customer-managed VPC). If you don't already have an account, https://redpanda.com/try-redpanda/cloud-trial[sign up for a free trial^].
...
. On the **Clusters** page, click **Create cluster**, then under **Serverless Standard**, click **Create**.
. For cluster settings, enter **connect-quickstart** for the cluster name.
. Select a resource group. If you don't have an existing resource group, you can create one. Refresh the page to see newly-created resource groups.
...
--
. Log in to https://cloud.redpanda.com[Redpanda Cloud^].
. On the **Clusters** page, click **Create cluster**, then under **Serverless Pro**, click **Create**.
. For cluster settings, enter **connect-quickstart** for the cluster name.
. Select a resource group. If you don't have an existing resource group, you can create one. Refresh the page to see newly-created resource groups.
. Use the default values for the remaining properties, then click **Create**.
...
--
. Log in to https://cloud.redpanda.com[Redpanda Cloud^].
. On the **Clusters** page, click **Create cluster**, then under **Dedicated**, click **Create**.
...
--
. Log in to https://cloud.redpanda.com[Redpanda Cloud^].
. On the **Clusters** page, click **Create cluster**, then under **Bring Your Own Cloud**, click **Create**.
. On the **Cluster settings** page, enter **connect-quickstart** for the cluster name.
. Select a resource group, If you don't have an existing resource group, you can create one. Refresh the page to see newly-created resource groups.
. Select your cloud provider, then use the default values for the remaining properties and click **Next**.
