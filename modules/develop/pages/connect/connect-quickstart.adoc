...
You'll use the following Redpanda Connect components:
...
. **Add a topic**: Select to create a new topic called **processed-emails**. Click **Next**.
...
.. Enable permissions for this user on your pipeline's topic.
.. Click **Next**.
