...
The `pg_database` system catalog stores information about the databases available in the cluster. It mimics the https://www.postgresql.org/docs/15/catalog-pg-database.html[pg_database^] PostgreSQL system catalog.
