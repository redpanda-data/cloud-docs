...
The `pg_user` system catalog provides a publicly readable view of database users. It mimics the https://www.postgresql.org/docs/15/view-pg-user.html[pg_user^] PostgreSQL system view.
