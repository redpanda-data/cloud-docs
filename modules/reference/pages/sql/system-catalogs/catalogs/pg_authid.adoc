...
The `pg_authid` system catalog stores information about database authorization identifiers (roles). It mimics the https://www.postgresql.org/docs/current/catalog-pg-authid.html[pg_authid^] PostgreSQL system catalog.
