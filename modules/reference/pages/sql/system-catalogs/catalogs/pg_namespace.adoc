...
[NOTE]
====
To learn more about Schema and how it is managed in Redpanda SQL, please refer to the xref:reference:sql/schema.adoc[schema documentation].
====
...
In this example, the "`sales`" and "`hr`" schemas are created using the query below:
