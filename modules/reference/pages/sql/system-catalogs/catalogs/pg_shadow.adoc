...
The `pg_shadow` system catalog provides a superuser-only view of database users with unmasked passwords. It mimics the https://www.postgresql.org/docs/current/view-pg-shadow.html[pg_shadow^] PostgreSQL system view.
