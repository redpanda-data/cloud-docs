...
The `pg_proc` system catalog stores information about functions and procedures. It mimics the https://www.postgresql.org/docs/15/catalog-pg-proc.html[pg_proc^] PostgreSQL system catalog.
