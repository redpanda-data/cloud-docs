...
The `pg_language` system catalog stores information about the procedural languages available in the database. It mimics the https://www.postgresql.org/docs/15/catalog-pg-language.html[pg_language^] PostgreSQL system catalog.
