...
The `pg_roles` system catalog provides a publicly readable view of database roles. It mimics the https://www.postgresql.org/docs/15/view-pg-roles.html[pg_roles^] PostgreSQL system view.
