...
This query returns `2, 1` as output.
...
This query returns `ERROR: relation "b" does not exist`, because `b` is not defined in this context or any of the contexts above.
