...
The result includes only the names that appear in both tables:
...
This means that if a row appears multiple times in any of the `SELECT` statements, it is included in the final result set multiple times.
...
Create three tables of products from different years. You want to find the common products among all three categories, including duplicates.
...
The result includes the products that are common among all three categories, including duplicates:
