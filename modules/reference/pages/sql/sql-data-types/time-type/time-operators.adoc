= Time operators
:description: Time operators in Redpanda SQL allow you to perform various operations on dates, times, and intervals.
:page-topic-type: reference

Time operators in Redpanda SQL allow you to perform various operations on dates, times, and intervals. Here’s a guide to using these operators:
