...
Adding and multiplying time operators can also be done in reverse order. For example, we add a number of days to a date in the format of `Integer {plus} Date`.
