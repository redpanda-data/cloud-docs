...
Oxla now supports scientific notation for floating-point types. This feature allows you to use expressions like 1.1e{plus}3, 1e-20, 1.1e02 and similar in your queries.
