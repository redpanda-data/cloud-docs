...
:description: Redpanda SQL allows aliases that can be used interchangeably with the primary data types.
:page-topic-type: reference

Redpanda SQL allows aliases that can be used interchangeably with the primary data types. However, while these aliases can be used, they will be mapped to their corresponding primary data types during data processing.
