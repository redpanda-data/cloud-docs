= Bool
:description: A BOOL is a data type mainly used for expressions that will return only two possible values, true and false.
...
The above query filters all records based on the specified conditions, showing that Sandra hasn’t returned the book yet:
