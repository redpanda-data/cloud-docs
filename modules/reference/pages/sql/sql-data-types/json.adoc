= JSON
:description: JSON stands for JavaScript Object Notation.
...
This will create a table with the `orders++_++Detail`column to store key-value pairs of data.
...
This will insert data values where `orders++_++Detail`has the following keys:
