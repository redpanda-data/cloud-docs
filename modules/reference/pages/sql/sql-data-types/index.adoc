...
// TODO (follow-up PR): Replace plain text ROW with xref once row.adoc page exists.
...
|ROW |A composite value containing fields of different types |`ROW(value1, value2, ...)`
|===
