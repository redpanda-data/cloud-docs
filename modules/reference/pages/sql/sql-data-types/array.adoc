= Array
:description: In Redpanda SQL, an array allows you to represent a collection of elements that have the same data type (any built-in data type can be used).
:page-topic-type: reference

In Redpanda SQL, an array allows you to represent a collection of elements that have the same data type (any built-in data type can be used).
