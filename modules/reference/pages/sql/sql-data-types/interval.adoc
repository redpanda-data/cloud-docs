...
|`unit`
a|Year, month, day, hour, and minute. Abbreviations, short forms, and dash format are supported. Plural forms are also acceptable (e.g. months, days, weeks).
...
In the output, only the minutes part is returned.
