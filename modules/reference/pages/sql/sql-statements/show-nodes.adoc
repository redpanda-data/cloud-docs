...
// TODO (follow-up PR): Add xref link to System Virtual Tables page once it exists.
NOTE: Related system virtual tables include `system.queries` (running queries) and `system.execs` (execution tasks).
