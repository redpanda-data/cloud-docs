...
[source,sql]
----
COPY production_redpanda=>employee_salary TO '/path/to/exportsalary.csv';
----
...
[source,sql]
----
COPY production_redpanda=>employee_salary (empid, empname, empsalary) TO '/path/to/exportsalary.csv';
----
...
[source,sql]
----
COPY (SELECT * FROM production_redpanda=>employee_salary WHERE empdept = 'Marketing') TO '/path/to/exportsalary.csv';
----
...
[source,sql]
----
COPY production_redpanda=>customer TO '/path/to/customerexport.csv' WITH (DELIMITER ';');
----
...
[source,sql]
----
COPY production_redpanda=>personal_details TO '/path/to/personalinfo.csv' WITH (HEADER ON);
----
...
[source,sql]
----
COPY production_redpanda=>example_table TO '/path/to/exampleexport.csv' WITH (NULL 'unknown');
----
...
[source,sql]
----
COPY production_redpanda=>book_inventory TO STDOUT;
----
...
[source,sql]
----
COPY production_redpanda=>film TO 's3://your-bucket/file_name'
...
[source,sql]
----
COPY production_redpanda=>film TO 'gs://your-bucket/file_name' WITH (GCS_CRED('/path/to/credentials.json'));
----
...
[source,sql]
----
COPY production_redpanda=>project TO 'gs://your-bucket/project_file' WITH (GCS_CRED('<contents of the credentials.json file>'));
----
...
[source,sql]
----
COPY production_redpanda=>project TO 'gs://your-bucket/project_file'
...
[source,sql]
----
COPY production_redpanda=>taxi_data TO 'wasbs://container-name/your_blob'
