...
[source,sql]
----
DESCRIBE TABLE production_redpanda=>transactions;
----
...
| database_name        | table_name   |    name     | type  | nullable |
+----------------------+--------------+-------------+-------+----------+
| production_redpanda  | transactions | tx_id       | INT   | f        |
| production_redpanda  | transactions | amount      | REAL  | f        |
| production_redpanda  | transactions | created_at  | TEXT  | f        |
+----------------------+--------------+-------------+-------+----------+
----
...
[source,sql]
----
DESCRIBE REDPANDA CATALOG production_redpanda;
----
