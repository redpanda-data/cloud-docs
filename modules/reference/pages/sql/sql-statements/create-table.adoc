...
NOTE: Before creating catalog tables, you must first create a Redpanda catalog connection. Regular `CREATE TABLE` for user-defined tables is not supported in Redpanda SQL.
// TODO (follow-up PR): Add xref link to CREATE REDPANDA CATALOG page once it exists.
