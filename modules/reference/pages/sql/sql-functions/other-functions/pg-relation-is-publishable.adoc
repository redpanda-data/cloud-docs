...
The`pg_relation_is_publishable()` function is used to determine whether a specified relation (table) can be published in a link:https://www.postgresql.org/docs/current/logical-replication-publication.html[publication^].
