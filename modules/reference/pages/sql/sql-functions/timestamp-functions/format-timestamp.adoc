...
The `FORMAT_TIMESTAMP()` function returns a given timestamp value in a specified format. Its syntax is as follows:
...
In this example, the two-digit year `09` has been changed to the nearest four-digit year i.e., `2009`. Similarly, `70` will become `1970`, and `10` will become `2010`.
