...
The `FORMAT_TIMESTAMP()`, when given multiple spaces in the input string, omits the spaces and only returns the correct timestamp value. Let’s see how it works using an example:
