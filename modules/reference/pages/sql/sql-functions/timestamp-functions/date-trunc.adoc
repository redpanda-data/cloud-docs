...
* `source`: The value to truncate. It can be `INTERVAL`, `TIMESTAMP` or `TIMESTAMP WITH TIME ZONE`
* `time_zone` _(applicable for the second syntax option)_: The time zone for the operation. It accepts `text` input
