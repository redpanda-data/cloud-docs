...
The `TO++_++CHAR` function formats various data types, including `date/time`, `integer`, `float point` and `numeric` into a formatted string.

== Syntax

The syntax for using the `TO++_++CHAR` function is as follows:
