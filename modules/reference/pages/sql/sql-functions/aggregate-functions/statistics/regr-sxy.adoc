= regr_sxy
:description: The `regr_sxy()` aggregate function calculates the sum of products of deviations for the dependent variable (y) and the independent variable (x) in a linear regression analysis.
