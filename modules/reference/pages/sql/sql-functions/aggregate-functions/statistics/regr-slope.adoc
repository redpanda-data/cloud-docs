= regr_slope
:description: The `regr_slope()` aggregate function calculates the slope of the regression line for a linear relationship between a dependent variable (y) and an independent variable (x).
