= AVG
:description: The AVG() function lets you calculate the average value of records.
:page-topic-type: reference

The `AVG()` function lets you calculate the average value of records. The supported input and return types are listed in the following table:
