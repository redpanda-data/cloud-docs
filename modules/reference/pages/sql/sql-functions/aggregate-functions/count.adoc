...
The `COUNT()` function retrieves the number of records that match a specific condition. It can be used with any data type supported by Redpanda SQL, and the output will be returned as a `BIGINT`.
