...
Let’s see how the `LOWER()` function works using an example with columns. We have a *personal++_++details* table containing columns *id*, *first++_++name*, *last++_++name*, and *gender* of retail store employees.
