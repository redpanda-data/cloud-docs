...
The following query checks which values of the *course_name* column end with "`ology`" in the preceding table:
...
The following **patients_data** table has a `NULL` value in the *allergies* column.
