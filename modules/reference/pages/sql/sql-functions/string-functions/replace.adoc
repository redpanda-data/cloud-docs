...
The `REPLACE()` function will find all occurrences of the '`New`' substring in the '`NewDatabase`' string and replace it with the '`Redpanda SQL`' substring, producing the following output:
