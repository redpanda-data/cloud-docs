...
The `LAG()` window function returns the values from specific rows based on the offset argument (previous to the current row in the partition). It can be used with all xref:reference:sql/sql-data-types/index.adoc[data types supported by Oxla]
