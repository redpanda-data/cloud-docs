...
The following result is the nearest integer smaller than or equal to the specified argument.
...
. Create a new table called *FloorRecords* with double-precision values using the following query:
+
[source,sql]
----
