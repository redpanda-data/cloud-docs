...
|Character sets available in the current database. Standard view, see https://www.postgresql.org/docs/current/infoschema-character-sets.html[PostgreSQL documentation^].

|`information_schema.columns`
|Columns of tables and views visible to the current role. Standard view, see https://www.postgresql.org/docs/current/infoschema-columns.html[PostgreSQL documentation^].

|`information_schema.key_column_usage`
|Columns constrained as keys (primary keys, unique constraints, foreign keys). Standard view, see https://www.postgresql.org/docs/current/infoschema-key-column-usage.html[PostgreSQL documentation^].
...
|Privileges granted on tables and table-like objects to the current role. Standard view, see https://www.postgresql.org/docs/current/infoschema-role-table-grants.html[PostgreSQL documentation^].

|`information_schema.role_usage_grants`
|USAGE privileges granted to the current role. Standard view, see https://www.postgresql.org/docs/current/infoschema-role-usage-grants.html[PostgreSQL documentation^].

|`information_schema.table_constraints`
|Table constraints (primary key, unique, foreign key, check) visible to the current role. Standard view, see https://www.postgresql.org/docs/current/infoschema-table-constraints.html[PostgreSQL documentation^].

|`information_schema.tables`
|Tables and views visible to the current role. Standard view, see https://www.postgresql.org/docs/current/infoschema-tables.html[PostgreSQL documentation^].
|===
