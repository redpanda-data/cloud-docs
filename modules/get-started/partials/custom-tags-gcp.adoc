After cluster creation, you may need to update custom resource labels and network tags for compliance or organizational requirements. You can manage this with the xref:manage:api/cloud-byoc-controlplane-api.adoc[Cloud Control Plane API]. The Control Plane API allows up to 16 custom resource labels and network tags in GCP.
