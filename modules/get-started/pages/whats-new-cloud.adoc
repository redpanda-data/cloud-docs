...
The xref:develop:terraform-provider.adoc[Redpanda Terraform provider] lets you can create and manage resources in Redpanda Cloud, such as clusters, topics, users, ACLs, networks, and resource groups.
