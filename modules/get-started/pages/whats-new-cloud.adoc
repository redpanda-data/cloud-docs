...
A cluster's *Overview* page now provides a wizard to quickly get started streaming your own data with a xref:XXX[Redpanda Connect pipeline]. This lets you stream data into and out of Redpanda without writing producer/consumer code. 
