...
=== Serverless quick start wizard with Redpanda Connect

A Serverless cluster's *Overview* page now provides a wizard to quickly get started streaming your own data with a xref:get-started:cluster-types/serverless.adoc#interact-with-your-cluster[Redpanda Connect pipeline]. This lets you stream data into and out of Redpanda without writing producer/consumer code. 
