...
=== Usage-based billing for BYOC

You can now use xref:billing:billing.adoc[usage-based billing commitments] for BYOC clusters and track your activity on the *Billing* page in Redpanda Cloud. Customers currently using usage-based billing on Serverless or Dedicated clusters can now also use it on new BYOC clusters.
