...
The xref:manage:terraform-provider.adoc[Redpanda Terraform provider] now supports managing Redpanda Connect pipelines and Roles. You can use the provider to create and manage data pipelines and role-based access control configurations in Redpanda Cloud.
