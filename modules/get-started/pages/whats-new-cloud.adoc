...
You can now configure the `auto_create_topics_enabled` cluster property to automatically create a topic if a client produces to a non-existent topic. Each cluster can have up to 40,000 topics.
