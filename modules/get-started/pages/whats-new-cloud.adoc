...
You can now xref:networking:azure-private-link-in-ui.adoc[configure Azure Private Link] for your BYOC or Dedicated cluster using the Cloud UI. It is generally available (GA) in both the Cloud UI and the Cloud API. 
