...
=== Usage-based billing for BYOC clusters

You can now use xref:billing:billing.adoc[usage-based billing commitments] for BYOC clusters. This allows you to use your existing marketplace billing and credits to quickly provision BYOC clusters.
