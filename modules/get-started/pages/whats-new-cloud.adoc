...
You can now edit certain cluster configurations with the xref:manage:api/cloud-serverless-controlplane-api.adoc[Control Plane API]. For example, you can enable and manage Iceberg topics
