...
Redpanda Cloud is starting to introduce beta versions of xref:develop:agents/about.adoc[AI agents] for agentic applications driven by a continuous data feed.
