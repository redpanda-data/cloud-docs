...
=== Azure Private Link in the UI

You can now xref:networking:azure-private-link-in-ui.adoc[configure Azure Private Link] for your BYOC or Dedicated cluster using the Cloud UI. 
