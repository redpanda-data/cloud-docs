...
=== VNet peering for Dedicated clusters on Azure

Redpanda now supports xref:networking:dedicated/azure/vnet-peering.adoc[virtual network (VNet) peerings] for Dedicated clusters on Azure.
