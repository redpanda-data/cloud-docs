...
The free trial for Redpanda Serverless on AWS now lasts 30 days, up from 14 days. The $100 (USD) credit allowance and 7-day grace period are unchanged. See xref:get-started:cluster-types/serverless.adoc[Serverless clusters].
