...
Automatic topic creation is now enabled in Redpanda Cloud, so when a client produces to a non-existent topic, the topic is created automatically. Each cluster can have up to 40,000 topics.
