...
[NOTE]
====
Remote MCP has been deprecated and removed from Redpanda Cloud documentation.
====
...
=== Redpanda Cloud Management MCP Server: Deprecated

[NOTE]
====
The Redpanda Cloud Management MCP Server has been deprecated and removed from Redpanda Cloud documentation.
====
...
[NOTE]
====
AI agents documentation has been deprecated and removed from Redpanda Cloud documentation.
====
