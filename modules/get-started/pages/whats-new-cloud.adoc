...
For a better customer experience, the Serverless Standard and Serverless Pro have been merged into one offering. xref:get-started:cluster-types/serverless-pro.adoc[Serverless clusters] now include the higher usage limits and a free trial. 
...
=== Serverless Pro usage limits increased
 ...
 clusters increased to: ingress = 100 MBps, egress = 300 MBps, partitions = 5000, and topics = 3000.
