...
=== Custom RBAC roles in the control plane

You can now create custom roles at the organization level with xref:security:authorization/rbac/rbac.adoc[role-based access control (RBAC)] in the control plane.
