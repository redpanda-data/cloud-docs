...
Redpanda Cloud now sends email notifications to organization admins when credit or commit balances reach spending thresholds (25%, 10%, and 5% remaining). You can manage your notification preferences or opt out at any time. See xref:billing:billing-notifications.adoc[Manage Billing Notifications].
