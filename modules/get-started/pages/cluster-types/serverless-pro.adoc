...
Redpanda Serverless is the fastest and easiest way to start data streaming. Serverless Pro is an enterprise-level version of xref:get-started:cluster-types/serverless.adoc[Serverless Standard] that comes with higher usage limits and dedicated support. For information about all Redpanda Cloud cluster types, see xref:get-started:cloud-overview.adoc#redpanda-cloud-cluster-types[].
...
+
--
To start using Serverless Pro, contact https://www.redpanda.com/price-estimator[Redpanda Sales^] to request a private offer. With this sign up, you get immediate access to dedicated support. 
