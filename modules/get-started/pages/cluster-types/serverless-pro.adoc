...
Redpanda Serverless is the fastest and easiest way to start data streaming. Serverless Pro is an enterprise-level version of xref:get-started:cluster-types/serverless.adoc[Serverless Standard] that comes with higher usage limits and dedicated support. For information about all Redpanda Cloud cluster types, see xref:get-started:cloud-overview.adoc[].
...
+
--
To start using Serverless Pro, contact https://redpanda.com/try-redpanda?section=enterprise-trial[Redpanda Sales^]. With this sign up, you get immediate access to dedicated support. 
...
With AWS Marketplace sign up, you do not have immediate access to dedicated support, only the https://redpandacommunity.slack.com/[Community Slack^] channel. To access your Enterprise support, contact https://support.redpanda.com/hc/en-us/requests/new[Redpanda Support^].
--
=====
...
. Navigate to the *Topics* page to create a topic. Under the *Actions* dropdown, you can produce messages to it. Add team members and grant them access with ACLs on the *Security* page. 
