...
+
** Standard Lasv3 Series = 8 cores per zone = 24 cores per region
** Standard Dsv3 Series = 2 cores per zone = 2 cores per region
** Standard Dadsv5 Series = 2 cores per zone = 4 cores per region

. Confirm there are no SKU restrictions for the VM size in availability zones using the Azure Cloud Shell:
+
----
