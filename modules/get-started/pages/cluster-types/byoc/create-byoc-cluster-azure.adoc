...
** Microsoft.Network
+
TIP: To check if an Azure resource provider is registered, run the following command in the Azure Cloud Shell:
+
``` 
...
Check if the Azure subscription has SKU restrictions for the VM size in the Azure Cloud Shell:
