...
:page-aliases: cloud:create-byoc-cluster-aws.adoc, deploy:deployment-option/cloud/create-byoc-cluster-aws.adoc. get-started:cluster-types/byoc/create-byoc-cluster-aws.adoc
