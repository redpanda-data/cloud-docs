...
+
NOTE: If you change from public access to private access after cluster creation, users without VPN access to your VPC will lose access to these services.
. Click *Next*.
