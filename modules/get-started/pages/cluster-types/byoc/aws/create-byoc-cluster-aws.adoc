...
* Ensure that the AWS user authenticating to AWS has adminstrator access to create IAM policies specified in xref:security:authorization/cloud-iam-policies.adoc[AWS IAM policies].
