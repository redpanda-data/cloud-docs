...
:learning-objective-1: Deploy a BYOVPC cluster on AWS using the Redpanda Terraform module
:learning-objective-2: Configure the Redpanda network and cluster resources using module outputs
:learning-objective-3: Enable PrivateLink on a BYOVPC cluster
