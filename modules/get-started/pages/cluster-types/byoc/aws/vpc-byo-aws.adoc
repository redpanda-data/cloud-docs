  ...
  "customer_managed_resources": {
    "aws": {
      ...
      "redpanda_connect_node_group_instance_profile": {
        "arn": "<redpanda_connect_node_group_instance_profile_arn from terraform outputs>"
      },
      ...
      "redpanda_connect_security_group": {
        "arn": "<redpanda_connect_security_group_arn from terraform outputs>"
      },
      "node_security_group": {
...
* IAM instance profile: Checks that `connectors_node_group_instance_profile`, `connectors_node_group_instance_profile`, `redpanda_connect_node_group_instance_profile`,
