...
* Familiarity with the xref:redpanda-cloud:manage:api/index.adoc[Redpanda Cloud API]. For example, you should be familiar with how to use the Cloud API to authenticate and create a cluster.
