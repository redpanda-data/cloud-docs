...
* xref:get-started:byoc-arch.adoc[Learn about the BYOC architecture].
* xref:get-started:cluster-types/byoc/aws/create-byoc-cluster-aws.adoc[Create a standard BYOC cluster on AWS].
* xref:networking:byoc/aws/index.adoc[Configure networking for BYOC clusters on AWS].
