...
Check your Azure subscription's virtual CPU (vCPU) quota for the specified virtual machine (VM) series in the target region. If needed, request a quota increase from Azure to avoid deployment issues. For more information, see the https://learn.microsoft.com/en-us/azure/quotas/view-quotas[Microsoft documentation^].

The following table shows vCPU requirements for different xref:reference:tiers/byoc-tiers.adoc[usage tiers]. The total number of vCPUs includes extra capacity necessary for upgrades. For example, Standard_D2ads_v5 on Tier 1 requires two nodes, with two vCPUs per node. With extra capacity for upgrades, the total vCPUs required for is eight.

[cols="1,2,1,1,1"]
|===
| Tier | VM size | Nodes required | vCPUs per node | Total vCPUs required

| Tier 1 | Standard_D2ads_v5 | 2 | 2 | 8
| Tier 2 | Standard_D2ads_v5 | 2 | 2 | 8
| Tier 3 | Standard_D2ads_v5 | 2 | 2 | 8
| Tier 4 | Standard_E2ads_v5 | 2 | 2 | 8
| Tier 5 | Standard_E4ads_v5 | 2 | 4 | 16
| Tier 6 | Standard_E8ads_v5 | 2 | 8 | 32
| Tier 7 | Standard_E16ads_v5 | 2 | 16 | 64
| Tier 8 | Standard_E16ads_v5 | 2 | 16 | 64
| Tier 9 | Standard_E32ads_v5 | 2 | 32 | 128
|===
