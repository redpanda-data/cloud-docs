...
:page-aliases: cloud:create-byoc-cluster-gcp.adoc, deploy:deployment-option/cloud/create-byoc-cluster-gcp, get-started:cluster-types/byoc/create-byoc-cluster-gcp.adoc
