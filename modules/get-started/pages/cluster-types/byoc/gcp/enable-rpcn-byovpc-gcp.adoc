...
To enable Redpanda Connect on an existing BYOVPC cluster, you must update your configuration.
...
====
```bash
# Account used to check for the existence of secrets, which are required to create Redpanda Connect pipelines.
