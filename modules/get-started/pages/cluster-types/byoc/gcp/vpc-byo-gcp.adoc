...
====
```bash
# Used to check for the existence of a Redpanda Connect Service Account with permissions to create pipelines.
...
{
  "name": "redpanda_redpanda_connect_api_role",
...
gcloud iam roles create redpanda_redpanda_connect_api_role --project=<service-project-id> --file redpanda-connect-api.role

gcloud projects add-iam-policy-binding <service-project-id> \
  --member="serviceAccount:redpanda-connect-api@<service-project-id>.iam.gserviceaccount.com" \
  --role='projects/<service-project-id>/roles/redpanda_redpanda_connect_api_role'
```
```bash
# Used to create Redpanda Connect pipelines.
...
gcloud iam service-accounts add-iam-policy-binding <redpanda_connect_api-gcp-sa-account-id>@<service-project-id>.iam.gserviceaccount.com \
    --role roles/iam.workloadIdentityUser \
    --member "serviceAccount:<service-project-id>.svc.id.goog[redpanda-connect-api/connectors-<redpanda_connect_api-gcp-sa-account-id>]"
```
```
gcloud iam service-accounts add-iam-policy-binding <redpanda_connect-gcp-sa-account-id>@<service-project-id>.iam.gserviceaccount.com \
    --role roles/iam.workloadIdentityUser \
    --member "serviceAccount:<service-project-id>.svc.id.goog[redpanda-connect/connectors-<redpanda_connect-gcp-sa-account-id>]"
```
====
