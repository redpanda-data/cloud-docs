...
1. Select your data sources: Connect an input data source (to stream data into Redpanda) or an output data sink (to stream data in Redpanda to an external system).
