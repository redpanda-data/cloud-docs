...
After you create a Serverless cluster, you are guided to use xref:develop:connect/about.adoc[Redpanda Connect] to quickly build and deploy streaming data pipelines or AI applications. 
