...
On the cluster's *Overview* page, click *Get started*, then follow the steps to use `rpk` to interact with your cluster from the command line. Here are some helpful commands:
