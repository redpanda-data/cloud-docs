...
The first time you sign in, the *Overview* page shows a *Get started* button whose *Connect from your terminal* option walks you through using `rpk`. You can also use these `rpk` commands at any time:
