...
| *Deployment*
| Redpanda's cloud (AWS/GCP in beta)
...
* Serverless on GCP is currently in a glossterm:beta[] release. To unlock this feature,// ...existing code...
...
--
====
// ...existing code... contact https://support.redpanda.com/hc/en-us/requests/new[Redpanda Support^].
