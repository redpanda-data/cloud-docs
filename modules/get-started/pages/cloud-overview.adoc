...
Redpanda offers four types of fully-managed cloud clusters. All products are fully managed and have access to unlimited storage and 200+ data connectors with xref:develop:connect/about.adoc[Redpanda Connect].

|===
| <<Serverless Standard>> | <<Serverless Pro>> | <<Dedicated Cloud>> | <<Bring Your Own Cloud (BYOC)>>

| For development use cases, starter projects, and applications with low or variable traffic. | For targeted use cases supporting moderate, sustained traffic and extra support. | For production clusters requiring expert cloud hosting, higher throughput, and extra isolation. | For production clusters requiring data sovereignty, the highest throughput, and added security.
...
* Enterprise support is staffed by streaming experts 24 hours a day, Mon-Fri, plus immediate escalation for production outages with 24/7 coverage.
==== 
