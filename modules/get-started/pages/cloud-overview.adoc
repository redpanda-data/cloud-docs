...
* *Data plane*: This is where your cluster lives. The term _data plane_ can be used interchangeably with _cluster_. The data plane is where you manage topics, consumer groups, and connectors. It is managed by an agent that receives cluster specifications from the control plane. 
