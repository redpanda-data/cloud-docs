...
* *Data plane*: This is where your cluster lives. The term _data plane_ can be used interchangeably with _cluster_. The data plane is where you manage topics, consumer groups, and connectors. 

* *Agent*: Redpanda uses an agent to send cluster specifications from the control plane to the data plane. 
