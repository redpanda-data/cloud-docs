...
| A development-level version of Serverless for starter projects and applications with low or variable traffic. | An enterprise-level version of Serverless for targeted use cases supporting moderate, sustained traffic. | For production clusters requiring expert cloud hosting, higher throughput, and extra isolation. | For production clusters requiring data sovereignty, the highest throughput, and added security.
...
Serverless Pro is similar to Serverless Standards, but it provides higher usage limits and dedicated support. 
