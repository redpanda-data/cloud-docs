...
* *Data plane*: This is where your cluster lives. The term _data plane_ is used interchangeably with _cluster_. The data plane is where you manage topics, consumer groups, and connectors.
