...
Features in limited availability are production-ready and are covered by Redpanda Support for early adoptors. The following features are currently in limited availability in Redpanda Cloud:

* Redpanda Connect for BYOC and Dedicated
* Serverless clusters (Standard and Pro)
...
Features in beta are available for testing and feedback. They are not supported for production environments. The following features are currently in beta in Redpanda Cloud:
