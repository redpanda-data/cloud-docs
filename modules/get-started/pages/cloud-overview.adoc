...
| Client connections = up to ?? | Client connections = up to 180,000 | Client connections = up to 450,000
| Retention = 1 TB | Retention = unlimited | Retention = unlimited
| SLA = 99.50% uptime | SLA = 99.95% uptime + 24x7 monitoring and alerting | SLA = 99.95% uptime SLA + 24x7 monitoring and alerting
