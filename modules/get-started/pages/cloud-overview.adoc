...
NOTE: Serverless is currently in a limited availability (LA) release with xref:get-started:cluster-types/serverless-pro.adoc#serverless-usage-limits[usage limits]. 
